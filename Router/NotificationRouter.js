...
NotificationRouter.post('/add', (req, res) => {
    const { recipient_role,user_id,title, message, hasButton } = req.body;
    console.log(req.body);
    mysqlconnection.query(
        'insert into notifications(recipient_role,user_id,title,message,hasButton) values(?,?,?,?,?);',
        [recipient_role,user_id,title, message, hasButton], (error, rows, fields) => {
            if (!error) {
